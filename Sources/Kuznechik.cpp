...
static inline uint8_t linearTransform(const SecureBuffer<16> &vector) noexcept {
    ...
    return
        linear_transform_table[0][vector[0]] ^
        linear_transform_table[1][vector[1]] ^
        linear_transform_table[2][vector[2]] ^
        linear_transform_table[3][vector[3]] ^
        linear_transform_table[4][vector[4]] ^
        linear_transform_table[5][vector[5]] ^
        vector[6] ^
        linear_transform_table[6][vector[7]] ^
        vector[8] ^
        linear_transform_table[5][vector[9]] ^
        linear_transform_table[4][vector[10]] ^
        linear_transform_table[3][vector[11]] ^
        linear_transform_table[2][vector[12]] ^
        linear_transform_table[1][vector[13]] ^
        linear_transform_table[0][vector[14]] ^
        vector[15];
}
...
static inline SecureBuffer<16> &R(SecureBuffer<16> &vector) noexcept {
...
static inline SecureBuffer<16> &invR(SecureBuffer<16> &vector) noexcept {
