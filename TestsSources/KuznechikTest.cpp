...
TEST(KuznechikTest, TestR) {
    ...
    EXPECT_EQ(testR(vector1), vector2);
    EXPECT_EQ(testR(vector2), vector3);
    EXPECT_EQ(testR(vector3), vector4);
    EXPECT_EQ(testR(vector4), vector5);
}

TEST(KuznechikTest, TestInvR) {
    SecureBuffer<16> vector1 =
        { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00 };
    SecureBuffer<16> vector2 =
        { 0x94, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 };
    ...
    SecureBuffer<16> vector5 =
        { 0x0d, 0x64, 0xa5, 0x94, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
    EXPECT_EQ(testInvR(vector5), vector4);
    EXPECT_EQ(testInvR(vector4), vector3);
    EXPECT_EQ(testInvR(vector3), vector2);
    EXPECT_EQ(testInvR(vector2), vector1);
}
