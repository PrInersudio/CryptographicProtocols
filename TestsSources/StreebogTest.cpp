...
TEST(StreebogTest, TestSubstitute) {
    SecureBuffer<64> pts[5] = {
        {
            0xb2, 0xb1, 0xcd, 0x1e, 0xf7, 0xec, 0x92, 0x42,
            0x86, 0xb7, 0xcf, 0x1c, 0xff, 0xe4, 0x9c, 0x4c,
            0x84, 0xb5, 0xc9, 0x1a, 0xfd, 0xe6, 0x94, 0x44,
            0x8a, 0xbb, 0xcb, 0x18, 0xfb, 0xe0, 0x96, 0x46,
            0x82, 0xb3, 0xc5, 0x16, 0xf9, 0xe2, 0x90, 0x40,
            0x80, 0xb1, 0xcd, 0x1e, 0xf7, 0xec, 0x92, 0x42,
            0x86, 0xb7, 0xcf, 0x1c, 0xff, 0xe4, 0x9c, 0x4c,
            0x84, 0xb5, 0xc9, 0x1a, 0xfd, 0xe6, 0x94, 0x44
        },
        {
            0x02, 0x8b, 0xa7, 0xf4, 0xd0, 0x1e, 0x7f, 0x9d,
            0x58, 0x48, 0xd3, 0xaf, 0x0e, 0xb1, 0xd9, 0x6b,
            0x9c, 0xe9, 0x8a, 0x6d, 0xe0, 0x91, 0x75, 0x62,
            0xc2, 0xcd, 0x44, 0xa3, 0xbb, 0x51, 0x61, 0x88,
            0xf8, 0xff, 0x1c, 0xbf, 0x5c, 0xb3, 0xcc, 0x75,
            0x11, 0xc1, 0xd6, 0x26, 0x6a, 0xb4, 0x76, 0x61,
            0xb6, 0xf5, 0x88, 0x18, 0x02, 0xa0, 0xe8, 0x57,
            0x6e, 0x03, 0x99, 0x77, 0x3c, 0x72, 0xe0, 0x73
        },
        {
        ...
        {
            0x92, 0xcd, 0xb5, 0x9a, 0xae, 0xb1, 0x85, 0xfc,
            0xc8, 0x0e, 0xc1, 0xc1, 0x70, 0x1e, 0x23, 0x0a,
            0x0c, 0xaf, 0x98, 0x03, 0x9e, 0x3e, 0x8f, 0x03,
            0x52, 0x8b, 0x56, 0xcd, 0xc5, 0xfe, 0x9b, 0xe9,
            0x68, 0xb9, 0x0e, 0xd1, 0x22, 0x1c, 0x36, 0x14,
            0x81, 0x87, 0xc4, 0x48, 0x14, 0x1b, 0x8c, 0x00,
            0x26, 0xb3, 0x9a, 0x76, 0x7c, 0x0f, 0x12, 0x36,
            0xfe, 0x45, 0x8b, 0x19, 0x42, 0xdd, 0x1a, 0x12
        },
        {
            0x48, 0x69, 0x06, 0xc5, 0x21, 0xf4, 0x5a, 0x8f,
            0x43, 0x62, 0x1c, 0xde, 0x3b, 0xf4, 0x45, 0x99,
            0x93, 0x6b, 0x10, 0xce, 0x25, 0x31, 0x55, 0x86,
            0x42, 0xa3, 0x03, 0xde, 0x20, 0x38, 0x85, 0x85,
            0x93, 0x79, 0x0e, 0xd0, 0x2b, 0x36, 0x85, 0x58,
            0x5b, 0x75, 0x0f, 0xc3, 0x2c, 0xf4, 0x4d, 0x92,
            0x5d, 0x62, 0x14, 0xde, 0x3c, 0x05, 0x85, 0x58,
            0x5b, 0x73, 0x0e, 0xcb, 0x2c, 0xf4, 0x40, 0xa5
        }        
    };
    static const SecureBuffer<64> res[5] = {
        {
            0x46, 0x45, 0xd9, 0x5f, 0xc0, 0xbe, 0xec, 0x2c,
            0x43, 0x2f, 0x89, 0x14, 0xb6, 0x2d, 0x4e, 0xfd,
            0x3e, 0x5e, 0x37, 0xf1, 0x4b, 0x09, 0x7a, 0xea,
            0xd6, 0x7d, 0xe4, 0x17, 0xc2, 0x20, 0xb0, 0x48,
            0x24, 0x92, 0xac, 0x99, 0x66, 0x67, 0xe0, 0xeb,
            0xdf, 0x45, 0xd9, 0x5f, 0xc0, 0xbe, 0xec, 0x2c,
            0x43, 0x2f, 0x89, 0x14, 0xb6, 0x2d, 0x4e, 0xfd,
            0x3e, 0x5e, 0x37, 0xf1, 0x4b, 0x09, 0x7a, 0xea
        },
        {
            0xdd, 0xf6, 0x44, 0xe6, 0xe1, 0x5f, 0x57, 0x33,
            0xbf, 0xf2, 0x49, 0x41, 0x04, 0x45, 0x53, 0x6f,
            0x4e, 0x9b, 0xd6, 0x9e, 0x20, 0x0f, 0x35, 0x96,
            0xb3, 0xd9, 0xea, 0x73, 0x7d, 0x70, 0xa1, 0xd7,
            0xd1, 0xb6, 0x14, 0x3b, 0x9c, 0x92, 0x88, 0x35,
            0x77, 0x58, 0xf8, 0xef, 0x78, 0x27, 0x8a, 0xa1,
            0x55, 0xf4, 0xd7, 0x17, 0xdd, 0xa7, 0xcb, 0x12,
            0xb2, 0x11, 0xe8, 0x7e, 0x7f, 0x19, 0x20, 0x3d
        },
        {
        ...
        {
            0xec, 0xd9, 0x5e, 0x28, 0x26, 0x45, 0xa8, 0x39,
            0x30, 0x04, 0x58, 0x58, 0x32, 0x5f, 0x5a, 0xfa,
            0x23, 0x41, 0xdc, 0x11, 0x0a, 0xd3, 0x03, 0x11,
            0x0e, 0xf6, 0x76, 0xd9, 0xac, 0x63, 0x50, 0x9b,
            0xf3, 0xa3, 0x04, 0x1b, 0x65, 0x14, 0x8f, 0x93,
            0xf5, 0xc9, 0x86, 0xf2, 0x93, 0xbb, 0x7c, 0xfc,
            0xef, 0x92, 0x28, 0x8a, 0xc3, 0x4d, 0xf0, 0x8f,
            0x63, 0xc8, 0xf6, 0x36, 0x2c, 0xd8, 0xf1, 0xf0
        },
        {
            0xf2, 0x91, 0x31, 0xac, 0x18, 0xe6, 0x13, 0x03,
            0x51, 0x96, 0x14, 0x85, 0x98, 0xe6, 0xc8, 0xe8,
            0xde, 0x6f, 0xe9, 0xe7, 0x5c, 0x84, 0x0c, 0x43,
            0x2c, 0x73, 0x11, 0x85, 0xf9, 0x06, 0xa8, 0xa8,
            0xde, 0x54, 0x04, 0xe1, 0x42, 0x8f, 0xa8, 0xbf,
            0x47, 0x35, 0x4d, 0x40, 0x8b, 0xe6, 0x3a, 0xec,
            0xb7, 0x96, 0x93, 0x85, 0x7f, 0x6e, 0xa8, 0xbf,
            0x47, 0x3d, 0x04, 0xe4, 0x8b, 0xe6, 0xeb, 0x00
        },        
    };
    for (uint8_t i = 0; i < 5; ++i)
        EXPECT_EQ(testSubstitute(pts[i]), res[i]);
}

TEST(StreebogTest, TestPermutate) {
    SecureBuffer<64> pts[5] {
        {
            0x46, 0x45, 0xd9, 0x5f, 0xc0, 0xbe, 0xec, 0x2c,
            0x43, 0x2f, 0x89, 0x14, 0xb6, 0x2d, 0x4e, 0xfd,
    ...
    static const SecureBuffer<64> res[5] {
        ...
        {
            0xdd, 0xbf, 0x4e, 0xb3, 0xd1, 0x77, 0x55, 0xb2,
            0xf6, 0xf2, 0x9b, 0xd9, 0xb6, 0x58, 0xf4, 0x11,
            0x44, 0x49, 0xd6, 0xea, 0x14, 0xf8, 0xd7, 0xe8,
            0xe6, 0x41, 0x9e, 0x73, 0x3b, 0xef, 0x17, 0x7e,
            0xe1, 0x04, 0x20, 0x7d, 0x9c, 0x78, 0xdd, 0x7f,
            0x5f, 0x45, 0x0f, 0x70, 0x92, 0x27, 0xa7, 0x19,
            0x57, 0x53, 0x35, 0xa1, 0x88, 0x8a, 0xcb, 0x20,
            0x33, 0x6f, 0x96, 0xd7, 0x35, 0xa1, 0x12, 0x3d
        },
        {
        ...
        {
            0xec, 0x30, 0x23, 0x0e, 0xf3, 0xf5, 0xef, 0x63,
            0xd9, 0x04, 0x41, 0xf6, 0xa3, 0xc9, 0x92, 0xc8,
            0x5e, 0x58, 0xdc, 0x76, 0x04, 0x86, 0x28, 0xf6,
            0x28, 0x58, 0x11, 0xd9, 0x1b, 0xf2, 0x8a, 0x36,
            0x26, 0x32, 0x0a, 0xac, 0x65, 0x93, 0xc3, 0x2c,
            0x45, 0x5f, 0xd3, 0x63, 0x14, 0xbb, 0x4d, 0xd8,
            0xa8, 0x5a, 0x03, 0x50, 0x8f, 0x7c, 0xf0, 0xf1,
            0x39, 0xfa, 0x11, 0x9b, 0x93, 0xfc, 0x8f, 0xf0
        },
        {
            0xf2, 0x51, 0xde, 0x2c, 0xde, 0x47, 0xb7, 0x47,
            0x91, 0x96, 0x6f, 0x73, 0x54, 0x35, 0x96, 0x3d,
            0x31, 0x14, 0xe9, 0x11, 0x04, 0x4d, 0x93, 0x04,
            0xac, 0x85, 0xe7, 0x85, 0xe1, 0x40, 0x85, 0xe4,
            0x18, 0x98, 0x5c, 0xf9, 0x42, 0x8b, 0x7f, 0x8b,
            0xe6, 0xe6, 0x84, 0x06, 0x8f, 0xe6, 0x6e, 0xe6,
            0x13, 0xc8, 0x0c, 0xa8, 0xa8, 0x3a, 0xa8, 0xeb,
            0x03, 0xe8, 0x43, 0xa8, 0xbf, 0xec, 0xbf, 0x00
        }
        
    };
    for (uint8_t i = 0; i < 5; ++i)
        EXPECT_EQ(testPermutate(pts[i]), res[i]);
}

TEST(StreebogTest, TestLinear) {
    SecureBuffer<64> pts[5] {
        {
            0xea, 0xfd, 0x2c, 0xeb, 0x48, 0xea, 0xfd, 0x2c,
            0x7a, 0x4e, 0xec, 0xe0, 0xb0, 0x7a, 0x4e, 0xec,
            0x09, 0x2d, 0xbe, 0x67, 0x20, 0x09, 0x2d, 0xbe,
            0x4b, 0xb6, 0xc0, 0x66, 0xc2, 0x4b, 0xb6, 0xc0,
            0xf1, 0x14, 0x5f, 0x99, 0x17, 0xf1, 0x14, 0x5f,
            0x37, 0x89, 0xd9, 0xac, 0xe4, 0x37, 0x89, 0xd9,
            0x5e, 0x2f, 0x45, 0x92, 0x7d, 0x5e, 0x2f, 0x45,
            0x3e, 0x43, 0xdf, 0x24, 0xd6, 0x3e, 0x43, 0x46
        }, 
        {
            0x3d, 0x12, 0xa1, 0x35, 0xd7, 0x96, 0x6f, 0x33,
            0x20, 0xcb, 0x8a, 0x88, 0xa1, 0x35, 0x53, 0x57,
            0x19, 0xa7, 0x27, 0x92, 0x70, 0x0f, 0x45, 0x5f,
            0x7f, 0xdd, 0x78, 0x9c, 0x7d, 0x20, 0x04, 0xe1,
            0x7e, 0x17, 0xef, 0x3b, 0x73, 0x9e, 0x41, 0xe6,
            0xe8, 0xd7, 0xf8, 0x14, 0xea, 0xd6, 0x49, 0x44,
            0x11, 0xf4, 0x58, 0xb6, 0xd9, 0x9b, 0xf2, 0xf6,
            0xb2, 0x55, 0x77, 0xd1, 0xb3, 0x4e, 0xbf, 0xdd
        },
        {
        ...
        {
            0x5c, 0x01, 0x5a, 0x18, 0x21, 0x5c, 0x01, 0x5a,
            0xb2, 0x9a, 0xf3, 0x78, 0x9d, 0xb2, 0x9a, 0xf3,
            0x2a, 0xa2, 0x51, 0x3a, 0xcc, 0x2a, 0xa2, 0x51,
            0xa9, 0xf5, 0x79, 0xc9, 0xa8, 0xa9, 0xf5, 0x79,
            0xff, 0x19, 0x32, 0x6d, 0x8a, 0xff, 0x19, 0x32,
            0x90, 0xd8, 0x61, 0xfe, 0x53, 0x90, 0xd8, 0x61,
            0xd2, 0xa6, 0xc0, 0xf4, 0x4b, 0xd2, 0xa6, 0xc0,
            0x93, 0x99, 0xe9, 0xf0, 0xf1, 0x93, 0x99, 0x65
        }, 
        {
            0xf0, 0x8f, 0xfc, 0x93, 0x9b, 0x11, 0xfa, 0x39,
            0xf1, 0xf0, 0x7c, 0x8f, 0x50, 0x03, 0x5a, 0xa8,
            0xd8, 0x4d, 0xbb, 0x14, 0x63, 0xd3, 0x5f, 0x45,
            0x2c, 0xc3, 0x93, 0x65, 0xac, 0x0a, 0x32, 0x26,
            0x36, 0x8a, 0xf2, 0x1b, 0xd9, 0x11, 0x58, 0x28,
            0xf6, 0x28, 0x86, 0x04, 0x76, 0xdc, 0x58, 0x5e,
            0xc8, 0x92, 0xc9, 0xa3, 0xf6, 0x41, 0x04, 0xd9,
            0x63, 0xef, 0xf5, 0xf3, 0x0e, 0x23, 0x30, 0xec
        }
    };
    static const SecureBuffer<64> res[5] {
        {
        ...
        {
            0x15, 0x5f, 0x7b, 0xb0, 0x40, 0xee, 0xc5, 0x23,
            0x15, 0x5f, 0x7b, 0xb0, 0x40, 0xee, 0xc5, 0x23,
            0x15, 0x5f, 0x7b, 0xb0, 0x40, 0xee, 0xc5, 0x23,
            0x15, 0x5f, 0x7b, 0xb0, 0x40, 0xee, 0xc5, 0x23,
            0x15, 0x5f, 0x7b, 0xb0, 0x40, 0xee, 0xc5, 0x23,
    ...
    for (uint8_t i = 0; i < 5; ++i)
        EXPECT_EQ(testLinear(pts[i]), res[i]);
}
